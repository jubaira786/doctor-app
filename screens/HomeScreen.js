  ...
  return (
    ...
    <View style={styles.homeScreen}>
      ...
      {/* <View style={styles.featureDoctor}>
        <View style={[styles.drCrick, styles.crickLayout]}>
          <View style={styles.crickChildShadowBox} />
          <View style={[styles.drCrickParent, styles.parentPosition]}>
            <Text style={[styles.drCrick1, styles.drCrick1Typo]}>
              Dr. Crick
            </Text>
        ...
        <View style={[styles.drLachinet, styles.crickLayout]}>
          <View style={styles.crickChildShadowBox} />
          <View style={[styles.drLachinetParent, styles.parentPosition]}>
            <Text style={[styles.drLachinet1, styles.drCrick1Typo]}>
              Dr. Lachinet
            </Text>
            <Text style={[styles.hours2, styles.hoursTypo]}>
              <Text style={styles.text}>{`$ `}</Text>
              <Text style={[styles.hours1, styles.hours1Typo]}>
                29.00/ hours
              </Text>
          ...
          <View style={[styles.group1, styles.groupPosition]}>
            <Text style={[styles.text5, styles.textTypo]}>
              <Text style={styles.text2}>2.9</Text>
              <Text style={styles.text3}>{` `}</Text>
            </Text>
            <Image
        ...
        <View style={[styles.drStrain, styles.crickLayout]}>
          <View style={styles.crickChildShadowBox} />
          <View style={[styles.drCrickParent, styles.parentPosition]}>
            <Text style={[styles.drStrain1, styles.drCrick1Typo]}>
              Dr. Strain
            </Text>
            <Text style={[styles.hours, styles.hoursTypo]}>
              <Text style={styles.text}>{`$ `}</Text>
        ...
        <View style={[styles.drCrick2, styles.crickLayout]}>
          <View style={styles.crickChildShadowBox} />
          <View style={[styles.drCrickParent, styles.parentPosition]}>
            <Text style={[styles.drCrick1, styles.drCrick1Typo]}>
              Dr. Crick
          ...
          <View style={[styles.group3, styles.groupPosition]}>
            <Text style={[styles.text13, styles.textTypo]}>
              <Text style={styles.text2}>3.7</Text>
              <Text style={styles.text3}>{` `}</Text>
            </Text>
            <Image
      ...
      <View style={styles.popularDoctor}>
        <Podo  name="Jubair Ahamed" spec="Child Specalist" src1={require("../assets/star.png")} src2={require("../assets/rectangle-508.png")}/>
        {/* <Podo name="Mohamed Rizwan" spec="Cardiology" src1={require("../assets/star.png")} src2={require("../assets/rectangle-508.png")}/> */}
        ...
        {/* <View style={[styles.drFillerupGrab, styles.drBlessingLayout]}>
          ...
          <View style={styles.imagePosition}>
            <Image
              style={[styles.imageChild, styles.imagePosition]}
              contentFit="cover"
              source={require("../assets/rectangle-5081.png")}
            />
          </View>
      </View> */}
        <View style={[styles.headline, styles.group4Layout]}>
      ...
      <View style={styles.profilePosition}>
        ...
        <View style={[styles.group4, styles.group4Layout]}>
          ...
          <View style={[styles.text18, styles.text18Position]}>
            ...
            >{`Hi User`}</Text>
            <Text style={[styles.findYourDoctor, styles.timeClr]}>
              Find Your Doctor
            </Text>
          </View>
        </View>
      ...
      {/* <View style={[styles.search, styles.searchLayout]}>
        ...
        >{`Search..... `}</Text>
        <Image
          style={[styles.searchItem, styles.groupIconLayout]}
          contentFit="cover"
          source={require("../assets/group-29.png")}
        />
      </View>
      <View style={styles.statsBer}>
        <View style={[styles.timeParent, styles.timePosition]}>
...
//         <View style={{flex:1}}>
//         <ScrollView>
//         <Text style={styles.txt}>Hi welcome</Text>
//       </ScrollView>
//       {/* <View style={styles.HomeScreen}> */}
//         <Image 
//         style={styles.menuIcon}
